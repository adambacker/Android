...
//    });
    ...
    this.markerDrawable_idle = new AR.ImageDrawable(poiData.image, 1, {
        zOrder: 0,
        opacity: 1.0,
        /*
            To react on user interaction, an onClick property can be set for each AR.Drawable. The property is a function which will be called each time the user taps on the drawable. The function called on each tap is returned from the following helper function defined in marker.js. The function returns a function which checks the selected state with the help of the variable isSelected and executes the appropriate function. The clicked marker is passed as an argument.
    ...
    this.markerDrawable_none = new AR.ImageDrawable(World.markerDrawable_none, 3, {
            zOrder: 1,
            offsetY: -0.4,
            opacity: 1.0,
            /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(poiData.image, 1, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });

    this.markerDrawable_selected_none = new AR.ImageDrawable(World.markerDrawable_none, 3, {
            zOrder: 1,
            offsetY: -0.4,
            opacity: 0.0,
            onClick: null
    ...
    this.distanceLabel = new AR.Label(poiData.distance, 1, {
        zOrder: 1,
        offsetY: 3,
        style: {
            textColor: '#FFFFFF',
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(10), 0.8, {
            zOrder: 1,
            offsetY: 2,
            style: {
                textColor: '#FFFFFF',
    ...
    */
    this.radarCircle = new AR.Circle(0.12, {
    ...
    */
    this.radarCircleSelected = new AR.Circle(0.12, {
        horizontalAnchor: AR.CONST.HORIZONTAL_ANCHOR.CENTER,
        opacity: 0.8,
        style: {
            fillColor: "#0066ff"
    ...
    */
    if (poiData.show_flag) {
        this.markerObject = new AR.GeoObject(markerLocation, {
            drawables: {
                cam: [this.markerDrawable_idle, this.markerDrawable_none, this.markerDrawable_selected, this.markerDrawable_selected_none, this.titleLabel, this.distanceLabel, this.descriptionLabel],
        ...
        this.markerObject = new AR.GeoObject(markerLocation, {
            drawables: {
                cam: [this.markerDrawable_idle, this.markerDrawable_none, this.markerDrawable_selected, this.markerDrawable_selected_none],
                indicator: this.directionIndicatorDrawable,
                radar: this.radardrawables
            }
        });
